...
func TestNearestWeekday(t *testing.T) {
	...
	tt := []struct {
		...
		{time.Date(2024, 9, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2024, 10, 1, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2024, 11, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		...
		{time.Date(2024, 9, 30, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2024, 10, 31, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2024, 11, 30, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2024, 12, 31, 0, 0, 0, 0, time.UTC), 31, 31},

		{time.Date(2024, 1, 1, 0, 0, 0, 0, time.UTC), 29, 29},
		{time.Date(2024, 2, 1, 0, 0, 0, 0, time.UTC), 29, 29},
		{time.Date(2024, 3, 1, 0, 0, 0, 0, time.UTC), 29, 29},
		{time.Date(2024, 4, 1, 0, 0, 0, 0, time.UTC), 29, 29},
		{time.Date(2024, 5, 1, 0, 0, 0, 0, time.UTC), 29, 29},
		{time.Date(2024, 6, 1, 0, 0, 0, 0, time.UTC), 29, 28},
		{time.Date(2024, 7, 1, 0, 0, 0, 0, time.UTC), 29, 29},
		{time.Date(2024, 8, 1, 0, 0, 0, 0, time.UTC), 29, 29},
		{time.Date(2024, 9, 1, 0, 0, 0, 0, time.UTC), 29, 30},
		{time.Date(2024, 10, 1, 0, 0, 0, 0, time.UTC), 29, 29},
		{time.Date(2024, 11, 1, 0, 0, 0, 0, time.UTC), 29, 29},
		{time.Date(2024, 12, 1, 0, 0, 0, 0, time.UTC), 29, 30},

		{time.Date(2025, 1, 1, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2025, 2, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2025, 3, 1, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2025, 4, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2025, 5, 1, 0, 0, 0, 0, time.UTC), 31, 30},
		{time.Date(2025, 6, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2025, 7, 1, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2025, 8, 1, 0, 0, 0, 0, time.UTC), 31, 29},
		{time.Date(2025, 9, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2025, 10, 1, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2025, 11, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2025, 12, 1, 0, 0, 0, 0, time.UTC), 31, 31},

		{time.Date(2025, 1, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2025, 2, 1, 0, 0, 0, 0, time.UTC), 30, 0},
		{time.Date(2025, 3, 1, 0, 0, 0, 0, time.UTC), 30, 31},
		{time.Date(2025, 4, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2025, 5, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2025, 6, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2025, 7, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2025, 8, 1, 0, 0, 0, 0, time.UTC), 30, 29},
		{time.Date(2025, 9, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2025, 10, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2025, 11, 1, 0, 0, 0, 0, time.UTC), 30, 28},
		{time.Date(2025, 12, 1, 0, 0, 0, 0, time.UTC), 30, 30},

		{time.Date(2026, 1, 1, 0, 0, 0, 0, time.UTC), 31, 30},
		{time.Date(2026, 2, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2026, 3, 1, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2026, 4, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2026, 5, 1, 0, 0, 0, 0, time.UTC), 31, 29},
		{time.Date(2026, 6, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2026, 7, 1, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2026, 8, 1, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2026, 9, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2026, 10, 1, 0, 0, 0, 0, time.UTC), 31, 30},
		{time.Date(2026, 11, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2026, 12, 1, 0, 0, 0, 0, time.UTC), 31, 31},

		{time.Date(2026, 1, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2026, 2, 1, 0, 0, 0, 0, time.UTC), 30, 0},
		{time.Date(2026, 3, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2026, 4, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2026, 5, 1, 0, 0, 0, 0, time.UTC), 30, 29},
		{time.Date(2026, 6, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2026, 7, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2026, 8, 1, 0, 0, 0, 0, time.UTC), 30, 31},
		{time.Date(2026, 9, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2026, 10, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2026, 11, 1, 0, 0, 0, 0, time.UTC), 30, 30},
		{time.Date(2026, 12, 1, 0, 0, 0, 0, time.UTC), 30, 30},

		{time.Date(2027, 1, 1, 0, 0, 0, 0, time.UTC), 31, 29},
		{time.Date(2027, 2, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2027, 3, 1, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2027, 4, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2027, 5, 1, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2027, 6, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2027, 7, 1, 0, 0, 0, 0, time.UTC), 31, 30},
		{time.Date(2027, 8, 1, 0, 0, 0, 0, time.UTC), 31, 31},
		{time.Date(2027, 9, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2027, 10, 1, 0, 0, 0, 0, time.UTC), 31, 29},
		{time.Date(2027, 11, 1, 0, 0, 0, 0, time.UTC), 31, 0},
		{time.Date(2027, 12, 1, 0, 0, 0, 0, time.UTC), 31, 31},
	}
